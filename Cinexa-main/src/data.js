export const movies = [
  {
    ...
    title: { English: 'Now Playing', Hindi: 'अभी चल रही फिल्में' },
    image:
  ...
  },
  {
    id: 2,
    category: 'popular',
    title: { English: 'Popular', Hindi: 'लोकप्रिय' },
    image:
  ...
  },
  {
    id: 3,
    category: 'top_rated',
    title: { English: 'Top Rated', Hindi: 'सबसे अधिक रेटेड' },
    image:
  ...
  },
  {
    id: 4,
    category: 'upcoming',
    title: { English: 'Upcoming', Hindi: 'आने वाली फिल्में' },
    image:
...
export const fetchJson = async (endpoint, options = {}) => {
  if (!apiKey) {
    throw new Error('TMDB API key is missing. Add VITE_API_KEY to .env.');
  }
